...
Field[6] = Threshold;
Field[6].IField = 1;
Field[6].LcMin = lc_fault1;
Field[6].LcMax = lc;
Field[6].DistMin = lc_fault1;
//Field[6].DistMax = lc_fault1+0.001;
Field[6].DistMax = 0.5*Hypot(Fault1_length,Fault1_width);

Field[66] = Threshold;
Field[66].IField = 11;
Field[66].LcMin = lc_fault2;
Field[66].LcMax = lc;
Field[66].DistMin = lc_fault2;
//Field[66].DistMax = lc_fault2+0.001;
Field[66].DistMax = 0.5*Hypot(Fault2_length,Fault2_width);

Field[7] = Min;
Field[7].FieldsList = {2,22,5,6,66};
...
//+
Hide {
  Point{1}; Point{2}; Point{3}; Point{4}; Point{5}; Point{6}; Point{10}; Point{14}; Curve{1}; Curve{2}; Curve{3}; Curve{4}; Curve{7}; Curve{8}; Curve{9}; Curve{10}; Curve{12}; Curve{13}; Curve{17}; Curve{21}; Surface{1}; Surface{14}; Surface{18}; Surface{22}; Surface{26}; Surface{27}; 
}
