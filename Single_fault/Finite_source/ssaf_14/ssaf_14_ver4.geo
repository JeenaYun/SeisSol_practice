...
Field[6].LcMax = lc;
Field[6].DistMin = 0.5*Hypot(Fault1_length,Fault1_width);
Field[6].DistMax = 0.5*Hypot(Fault1_length,Fault1_width)+0.001;
//Field[6].DistMin = 2*lc_fault1;
//Field[6].DistMax = 2*lc_fault1+0.001;

Field[66] = Threshold;
Field[66].IField = 11;
Field[66].LcMin = lc_fault2;
Field[66].LcMax = lc;
Field[66].DistMin = 0.5*Hypot(Fault2_length,Fault2_width);
Field[66].DistMax = 0.5*Hypot(Fault2_length,Fault2_width)+0.001;
//Field[66].DistMin = 2*lc_fault2;
//Field[66].DistMax = 2*lc_fault2+0.001;
