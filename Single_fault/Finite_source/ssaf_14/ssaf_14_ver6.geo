...
Field[44] = Threshold;
Field[44].IField = 1;
Field[44].LcMin = lc_fault2;
Field[44].LcMax = lc;
Field[44].DistMin = lc_fault2;
Field[44].DistMax = lc_fault2+0.001;

Field[55] = Restrict;
Field[55].IField = 44;
Field[55].FacesList = {110} ;

//equivalent of propagation size on element
Field[6] = Threshold;
Field[6].IField = 1;
Field[6].LcMin = lc_fault2;
Field[6].LcMax = lc;
Field[6].DistMin = lc_fault2;
Field[6].DistMax = lc_fault2+0.001;

Field[7] = Min;
//Field[7].FieldsList = {2,22,5,6};
Field[7].FieldsList = {2,5,55,6};
